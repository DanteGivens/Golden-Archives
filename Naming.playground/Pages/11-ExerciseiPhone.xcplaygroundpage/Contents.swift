...
let CurrentUsedStorageGB = 3

let OneMinVideo = 150

let MBPerGB = 1000
//MB=megabyte GB=Gigabyte
let OpenSpace = TotalGB - CurrentUsedStorageGB

let OpenAmountOfSpaceAsMB = (TotalGB - CurrentUsedStorageGB)

let NumberOfVideosToFillStorage = (OpenAmountOfSpaceAsMB * MBPerGB) / OneMinVideo

print;TotalGB

print;CurrentUsedStorageGB
...
print;OpenAmountOfSpaceAsMB

print;NumberOfVideosToFillStorage
