...
let fullyWakingUp = 10

let PuttingOnClothes = 5

let WaitingToLeaveforbus = 30
//ususally I just play mobile games
...
let TotalTimetoLeave = brushTeeth + chooseClothes + getWater + fullyWakingUp + PuttingOnClothes + WaitingToLeaveforbus
...
let FunMinutesWhileWaiting = WaitingToLeaveforbus + fullyWakingUp

let ThingsIHavetodo = brushTeeth + chooseClothes + getWater + PuttingOnClothes
...
*/
let FullyWakingUp = 30

let brushteeth = 3

let waitingtoLeaveforbus = 45

let drinkwater = 1

let putclotheson = 2
//i'll have my clothes ready and quick to put on plus i would just wake up earlier.
